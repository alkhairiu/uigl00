...
export const games = [
  {
    ...
    name: "Mobile Legends",
    shortName: "ML",
    tagline: "5v5 Skill-Based MOBA",
    description:
      "Battle 5v5 penuh strategi. Kumpulkan tim terbaikmu, susun draft pick yang mematikan, dan menangkan pertandingan.",
    format: "5v5",
    slots: 512,
  ...
  },
  {
    ...
    description:
      "Adu taktik dan skill individu di lapangan digital. Format 1v1 head-to-head.",
    format: "1v1",
    slots: 64,
  ...
  },
  {
    ...
    name: "PUBG Mobile",
    shortName: "PM",
    tagline: "Battleground",
    description:
      "Siapa yang malam ini mau makan ayam!",
